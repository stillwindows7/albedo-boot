...
public class TestTreeResourceIntTest {
    ...
    @Before
    public void setup() {
        testTreeRepository.delete(null);
     ...
     */
    public static TestTree createEntity() {
    ...
    public void initTest() {
        testTree = createEntity();
    }

    @Test
    @Transactional
    public void createTestTree() throws Exception {
        int databaseSizeBeforeCreate = testTreeService.findAll().size();
        ...
        List<TestTree> testTreeList = testTreeService.findAll(
            Condition.create().orderBy(TestTree.F_CREATEDDATE, true)
    ...
    public void createTestTreeWithExistingName() throws Exception {
        testTreeRepository.insert(testTree);
        int databaseSizeBeforeCreate = testTreeService.findAll().size();
    ...
    public void checkCodeIsRequired() throws Exception {
        int databaseSizeBeforeTest = testTreeService.findAll().size();
        // set the field null
    ...
    public void updateTestTree() throws Exception {
        ...
        int databaseSizeBeforeUpdate = testTreeService.findAll().size();

        // Update the testTree
        TestTree updatedTestTree = testTreeService.findOne(testTree.getId());
    ...
    public void deleteTestTree() throws Exception {
        ...
        int databaseSizeBeforeDelete = testTreeService.findAll(spec).size();
        ...
        List<TestTree> testTreeList = testTreeService.findAll(spec);
