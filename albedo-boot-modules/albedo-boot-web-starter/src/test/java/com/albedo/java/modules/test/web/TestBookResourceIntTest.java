...
public class TestBookResourceIntTest {
    ...
    @Before
    public void setup() {
        testBookRepository.delete(null);
     ...
     */
    public static TestBook createEntity() {
    ...
    public void createTestBook() throws Exception {
        ...
        List<TestBook> testBookList = testBookService.findAll(
            Condition.create().orderBy(TestBook.F_CREATEDDATE, true)
        );
    ...
    public void createTestBookWithExistingEmail() throws Exception {
        testBookRepository.insert(testBook);
        int databaseSizeBeforeCreate = testBookService.findAll().size();
    ...
    public void updateTestBook() throws Exception {
        ...
        // Update the testBook
        TestBook updatedTestBook = testBookService.findOne(testBook.getId());
    ...
    public void deleteTestBook() throws Exception {
        ...
        int databaseSizeBeforeDelete = testBookService.findAll(spec).size();
        ...
        List<TestBook> testBookList = testBookService.findAll(spec);
