...
public class TestBookResourceIntTest {
	...
	private static final Date DEFAULT_RESETDATE = PublicUtil.getCurrentDate();
	/** UPDATED_RESETDATE reset_date  :  reset_date */
    private static final Date UPDATED_RESETDATE = DateUtil.addDays(PublicUtil.getCurrentDate(), 1);
